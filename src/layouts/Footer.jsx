    ...
    return (
        <section className='bg-brand-light relative pt-10'>
            ...
            <div className='relative z-20 flex gap-4 items-center justify-center flex-col sm:flex-row'>
                <a href="#" className="text-black-300 hover:text-white px-3 ">Llantas</a>
                <p className='hidden sm:block'> • </p>
                <a href="#" className="text-black-300 hover:text-white px-3 ">Puntos de venta</a>
                <p className='hidden sm:inline-block'> • </p>
                <a href="#" className="text-black-300 hover:text-white px-3">Contacto</a>
            </div>
