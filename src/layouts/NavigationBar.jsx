...
function NavigationBar() {
    return (
        <div>
            <nav class="bg-brand-light p-4">
                <div class="container mx-auto flex justify-between items-center">
                    <div class="text-black font-bold text-xl flex items-center justify-center">
                    ...
                    <div>
                        ...
                        <a href="#" class="text-black-300 hover:text-white px-3">Login</a>
                    </div>
                </div>
            </nav>  
        </div>
